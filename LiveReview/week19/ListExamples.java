...
// ***** Likewise TreeSet does not accept null value since internally using Sorting
        ...
        for (int i = 0; i < listThree.size();) {    //   9 --> 8 -----> ......0  size becomes zero that is why we get out of
        //    loop , we don't need i++ increment'
        ...
        // since we can cast the list to LinkList it allows us to use Deque methods such as
