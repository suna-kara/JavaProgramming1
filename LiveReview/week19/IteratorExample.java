...
public class IteratorExample {
    public static void main(String[] args) {
        /*
       1. We need to ****** create iterator obj to able to use***** it*****.****
       2. *** We move the pointer using next() method***
       3. *** hasNext() method return true, if there is still next value***
       4. *We can remove values using values using remove() method
         */
        ...
        // ıterator is another way of looping inside your collection

        List<Integer> nums2=new LinkedList<>();
        nums2.addAll(Arrays.asList(34,67,33,12,11,65,100));

        for (Integer integer : nums2){  // Exception in thread  "main" java
