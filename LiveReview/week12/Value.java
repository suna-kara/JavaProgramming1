...
it getVal returns the last value passed to setVal. Otherwise if the "single int parameter" constructor
was used to create the object, getVal returns the value passed to that constructor. Otherwise getVal returns 0.
     */

    int param=0;// you can omit initializing to zero
    boolean calledMethod=false;
    boolean calledConstructor=true;
    ...
    public void setValue(int param){//one parameter method and is void
        ...
        public int getValue(){
        /*
        below codes becomes redundant because it
        s going to return instance variable in all conditions
