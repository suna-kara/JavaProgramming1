...
2. Find the person
3.Retrive salary
cydeo.get(eachEmp)---> this brings value of each key : Object of Employee Class
 */
     double expectedSalary=0;
        for (String eachEmp : cydeo.keySet()) {
            Employee temp=(Employee) cydeo.get(eachEmp);  // This brings an Object.I need to cast it to Employee class obj
      ...
      */
        ...
        for (Map.Entry<String, Object> eachEmpEntry : cydeo.entrySet()) {
         Employee temp=(Employee)   eachEmpEntry.getValue();   // This brings an Object.I need to cast it to Employee class obj
