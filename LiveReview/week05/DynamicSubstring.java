...
public class DynamicSubstring {
    public static void main(String[] args) {
        ...
        String  today= "I coded a lot of [Java] today"; //imagine that inside sguare brackets is dynamic
        //Get me word inside brackets using indexof and substring methods
