        ...
        while (Continue){
            ...
            switch (choice){
                ...
                case 3:
                    ...
                    shoppingList.modifyGroceryItem(itemNo,input.nextLine());
                ...
                case 5:
                    ...
                    String searcItem=input.nextLine();
                    System.out.println(shoppingList.findItem(searcItem));
                    break;
                case 6:
                    Continue=false;
                    break;
