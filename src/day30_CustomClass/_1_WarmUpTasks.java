...
public class _1_WarmUpTasks {
    public static void main(String[] args) {
     ...
     ArrayList<Character> letters=new ArrayList<>( chars );// add all the caharacters

    letters.removeIf(p-> !Character.isLetter(p)); // lambda :fonksiyonları ve birleşme şekillerini tanımlayan üst seviye programlama dillerinde kullanılan hesaplama modeli	lambda calculus i.
   ...
   digits.removeIf(p-> !Character.isDigit(p)); // remove the characters that are not digits
        ...
        ArrayList<Character> specialChar=new ArrayList<>( chars );// add all the caharacters
