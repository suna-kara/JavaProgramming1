...
public class _2_ArraysPractice {
    public static void main(String[] args) {
        // store teh elemenets:10,20,50,70
        ...
        String[] months={"January","February","March","April","May","June","July","August","September","November","October","December"};// 0~11(length-1)
/*
