...
public class _8_MinMaxNumbers {
    public static void main(String[] args) {
        Scanner scan=new Scanner(System.in);
        int[] numbers=new int[10];

        for (int i = 0; i < numbers.length; i++) {//Scanner i loop dışında oluşturmak daha mantıklı.icerde oluşturursak 10 defa scanner olusur.bir defa oluşrutmak yeterli
