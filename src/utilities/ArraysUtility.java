...
public class ArraysUtility {
    ...
    // print each integer of an int array in seperate lines
    ...
    // returns the min num for double array
    ...
    // returns the min num for int array
    ...
    // returns the unique elements of the array as a new array
    public static String[] uniqueElements(String[] array) {// if the frequency is one,the element is unique
